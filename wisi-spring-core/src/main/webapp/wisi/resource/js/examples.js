Ext.example = function(){
    ...
    return {
        msg : function(title, format){
            if(!msgCt){
                msgCt = Ext.DomHelper.insertFirst(Ext.getCmp('pageFrameTopSouthRightToolbar').body, {id:'msg-div'}, true);
            }
        ...
        init : function(){
            if(!msgCt){
                ...
                //msgCt = Ext.DomHelper.insertFirst(Ext.getCmp('messageDisplay').body, {id:'msg-div'}, true);
            }
