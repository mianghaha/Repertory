...
public class WisiHandlerException implements HandlerExceptionResolver {
	/** Logger define */
	private static final Logger logger = ComLogger.getInstance();
	
	/** The json name of the request header: "accept". */
	public static final String REQUEST_HEADER_KEY_01 = "accept";
	
	/** The json name of the request header: "X-Requested-With". */
	public static final String REQUEST_HEADER_KEY_02 = "X-Requested-With";
	
	/** The json name of the request header value: "application/json". */
	public static final String REQUEST_HEADER_VALUE_01 = "application/json";
	
	/** The json name of the request header value: "X-Requested-With". */
	public static final String REQUEST_HEADER_VALUE_02 = "XMLHttpRequest";
